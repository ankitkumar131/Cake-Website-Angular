    ...
    <div class="container mx-auto px-4 py-12">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-1">
          <div
            class="bg-white p-6 rounded-lg border border-gray-200 sticky top-24"
          >
            ...
            <div class="space-y-2">
              <div class="flex items-center">
                ...
                />
                <label for="all" class="ml-2 text-sm text-gray-700"
                  >All Products</label
                >
              </div>
              ...
              <div class="flex items-center">
                <input
                  ...
                  class="h-4 w-4 text-primary border-gray-300 focus:ring-primary"
                />
                <label [for]="category" class="ml-2 text-sm text-gray-700">{{
  ...
  applyFilters(): void {
    ...
    if (this.selectedCategory) {
      filtered = filtered.filter((product) =>
        product.type.includes(this.selectedCategory as Category)
      );
    }
    ...
    if (this.minPrice !== null) {
      filtered = filtered.filter(
        (product) => product.price >= (this.minPrice || 0)
      );
    }

    if (this.maxPrice !== null) {
      filtered = filtered.filter(
        (product) => product.price <= (this.maxPrice || Infinity)
      );
    }
